...
from get_target_path import get_target_path_WRITE_secure
...
def write_file(working_directory: str, file_path: str, content: str) -> str:
    ...
    if isinstance(target_path, str):
        return utils.error_message_generic(target_path) + utils.write_fail_message_to_append()
    ...
    try:
        ...
        #      f.write(content)
        #return utils.success_message_with_header_WRITE(target_path, content)
