...
def main() -> None:
    ...
    #Check that a first argument is supplied (the argument should be the mathematical expression to calculate)
    if len(sys.argv) <= 1:
    ...
    #Evaluate mathematical expression provided in string format
